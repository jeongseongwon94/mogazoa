...
export default function ActivityCard({
	...
	return (
		<div className="flex h-[11.9rem] w-[10.5rem] grow flex-col items-center justify-center gap-[1.5rem] rounded-[1.2rem] border border-[#353542] bg-[#252530] md:w-[16.3rem] lg:h-[12.8rem] lg:w-[30rem] lg:gap-[2rem]">
